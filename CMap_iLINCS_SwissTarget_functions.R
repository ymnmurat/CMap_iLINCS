...
multi_heatmaps_SwissCMapILINCS=function(swisstargetDir='swisstarget', iLINCSconnectivityDir='../ilincs/', cmapConnectDir='../cmap/',singleAnnotationTag='Measurements', annotationLegendTitle='user input logFC data',refdata=NULL, candygenes, swissFocus=T, CellLine='HA1E', secondCellLine=NULL, summaryDATA=F, nacols=NULL, mainPlotHeight=1.5, gridheights=1.5, gridwidths=0.3,rowLabelSizeMain=14, legendTitleFontSize=12, rowLabelSizeRest=14,width_heat=20, height_heat=14, res_heat=600){
  a=try({
  ...
  }else{CellLine='SUMMARY'; secondCellLine=NULL; conndata_stp=NULL; conndata_stp2=NULL}
  ...
  if(!is.null(conndata_stp)){conndata_stp_tags=heatmaptags(conndata_stp, nacols=nacols)}
  ...
  cols=colgenaid(stp); if(!is.null(conndata_stp)){cols_ilincs_Con=colgenaid(conndata_stp)}; cols_cmap_kd_Con=colgenaid(conndata_cmap_kd_stp); cols_cmap_oe_Con=colgenaid(conndata_cmap_oe_stp)
  ...
  if (!is.null(refdata)) {if (ncol(refdata)==1) {
    ha = HeatmapAnnotation(E2_JAS=as.matrix(refdata_tags$dataset), col = list(E2_JAS=as.function(refdata_tags$f1)), height = unit(1, "cm"), annotation_legend_param = list(E2_JAS= list(legend_direction="horizontal",grid_height = unit(gridheights, "cm"),grid_width = unit(gridwidths, "cm"),labels_gp = gpar(fontsize = 7, fontface = "bold"),title_gp = gpar(fontsize = legendTitleFontSize, fontface = "bold"), title=annotationLegendTitle)), na_col = nacols, annotation_name_side = 'right'); if(refdata_tags$f1tag){ha@anno_list$E2_JAS@legend_param$at=refdata_tags$at; ht1@anno_list$E2_JAS@legend_param$labels=refdata_tags$labels}
  ...
  ht1=Heatmap(t(stp_tags$dataset),cluster_rows = F,  col = as.function(stp_tags$f1), name= "SwissTarget \nsimilarity scores",top_annotation=ha,row_names_gp = gpar(fontsize = rowLabelSizeMain, fontface = "bold", col=cols),column_names_gp = gpar(fontsize = 15, fontface = "bold"),
              heatmap_legend_param=list(legend_direction="horizontal",grid_height = unit(gridheights, "cm"),grid_width = unit(gridwidths, "cm"),labels_gp = gpar(fontsize = 7),title_gp = gpar(fontsize = legendTitleFontSize, fontface = "bold")),cluster_columns=F,row_title = "SwissTargetPrediction", row_title_rot = 0,row_title_gp = gpar(fontsize=20,fontface='bold', fill = "red", col = "white", border = "blue"), na_col = nacols, height = mainPlotHeight,use_raster=F); if(stp_tags$f1tag){ht1@matrix_legend_param$at=stp_tags$at; ht1@matrix_legend_param$labels=stp_tags$labels}
  
  if(!is.null(conndata_stp)){ht2=Heatmap(t(conndata_stp_tags$dataset),cluster_rows = F, cluster_columns = F, col = as.function(conndata_stp_tags$f1), name= paste0(CellLine," z-scores \niLINCS Connectivity (kd)"),row_names_gp = gpar(fontsize = rowLabelSizeRest, fontface = "bold", col=cols_ilincs_Con),column_names_gp = gpar(fontsize = 15, fontface = "bold"),row_title = paste0(CellLine," iLINCS Connectivity (kd)"), row_title_rot = 0, row_title_gp = gpar(fontsize=20,fontface='bold', fill = "red", col = "white", border = "blue"), heatmap_legend_param=list(legend_direction="horizontal",grid_height = unit(gridheights, "cm"),grid_width = unit(gridwidths, "cm"),labels_gp = gpar(fontsize = 7),title_gp = gpar(fontsize = legendTitleFontSize, fontface = "bold")), na_col = nacols,height = 1.5,use_raster=F); if(conndata_stp_tags$f1tag){ht2@matrix_legend_param$at=conndata_stp_tags$at;ht2@matrix_legend_param$labels=conndata_stp_tags$labels}}
  
  ht3=Heatmap(t(conndata_cmap_kd_stp_tags$dataset),cluster_rows = F, cluster_columns = F, col = as.function(conndata_cmap_kd_stp_tags$f1), name= paste0(CellLine, " CMap Connectivity (kd)"),row_names_gp = gpar(fontsize = rowLabelSizeRest, fontface = "bold", col=cols_cmap_kd_Con),column_names_gp = gpar(fontsize = 15, fontface = "bold"),row_title = paste0(CellLine," CMap Connectivity (kd)"), row_title_rot = 0, heatmap_legend_param=list(legend_direction="horizontal",grid_height = unit(gridheights, "cm"),grid_width = unit(gridwidths, "cm"),labels_gp = gpar(fontsize = 7),title_gp = gpar(fontsize = legendTitleFontSize, fontface = "bold")), na_col = nacols,height = 1.5,use_raster=F); if(conndata_cmap_kd_stp_tags$f1tag){ht3@matrix_legend_param$at=conndata_cmap_kd_stp_tags$at;ht3@matrix_legend_param$labels=conndata_cmap_kd_stp_tags$labels}
  
  ht4=Heatmap(t(conndata_cmap_oe_stp_tags$dataset),cluster_rows = F, cluster_columns = F, col = as.function(conndata_cmap_oe_stp_tags$f1), name= paste0(CellLine, " CMap Connectivity (oe)"),row_names_gp = gpar(fontsize = rowLabelSizeRest, fontface = "bold", col=cols_cmap_oe_Con),column_names_gp = gpar(fontsize = 15, fontface = "bold"),row_title = paste0(CellLine, " CMap Connectivity (oe)"), row_title_rot = 0, heatmap_legend_param=list(legend_direction="horizontal",grid_height = unit(gridheights, "cm"),grid_width = unit(gridwidths, "cm"),labels_gp = gpar(fontsize = 7),title_gp = gpar(fontsize = legendTitleFontSize, fontface = "bold")), na_col = nacols,height = 1.5,use_raster=F); if(conndata_cmap_oe_stp_tags$f1tag){ht4@matrix_legend_param$at=conndata_cmap_oe_stp_tags$at;ht4@matrix_legend_param$labels=conndata_cmap_oe_stp_tags$labels}
  
  if (!is.null(conndata_stp2)|!is.null(conndata_cmap_kd_stp2)|!is.null(conndata_cmap_oe_stp2)) {
    ht12=Heatmap(t(conndata_stp2_tags$dataset),cluster_rows = F, cluster_columns = F,col = as.function(conndata_cmap_kd_stp2_tags$f1), name= paste0(secondCellLine," z-scores \niLINCS Connectivity (kd)"),row_names_gp = gpar(fontsize = rowLabelSizeRest, fontface = "bold", col=cols_ilincs_Con),column_names_gp = gpar(fontsize = 15, fontface = "bold"),row_title = paste0(secondCellLine," iLINCS Connectivity (kd)"), row_title_rot = 0,row_title_gp = gpar(fontsize=20,fontface='bold', fill = "red", col = "white", border = "blue"), heatmap_legend_param=list(legend_direction="horizontal",grid_height = unit(gridheights, "cm"),grid_width = unit(gridwidths, "cm"),labels_gp = gpar(fontsize = 7),title_gp = gpar(fontsize = legendTitleFontSize, fontface = "bold")), na_col = nacols,height = 2,use_raster=F); if(conndata_stp2_tags$f1tag){ht12@matrix_legend_param$at=conndata_stp2_tags$at;ht12@matrix_legend_param$labels=conndata_stp2_tags$labels}
    
    ht13=Heatmap(t(conndata_cmap_kd_stp2_tags$dataset),cluster_rows = F, cluster_columns = F, col = as.function(conndata_cmap_kd_stp2_tags$f1), name= paste0(secondCellLine, " CMap Connectivity (kd)"),row_names_gp = gpar(fontsize = rowLabelSizeRest, fontface = "bold", col=cols_cmap_kd_Con2),column_names_gp = gpar(fontsize = 15, fontface = "bold"),row_title = paste0(secondCellLine, "  CMap Connectivity (kd)"), row_title_rot = 0, heatmap_legend_param=list(legend_direction="horizontal",grid_height = unit(gridheights, "cm"),grid_width = unit(gridwidths, "cm"),labels_gp = gpar(fontsize = 7),title_gp = gpar(fontsize = legendTitleFontSize, fontface = "bold")), na_col = nacols,height = 1.5,use_raster=F); if(conndata_cmap_kd_stp2_tags$f1tag){ht13@matrix_legend_param$at=conndata_cmap_kd_stp2_tags$at;ht13@matrix_legend_param$labels=conndata_cmap_kd_stp2_tags$labels}
    
    ht14=Heatmap(t(conndata_cmap_oe_stp2_tags$dataset),cluster_rows = F, cluster_columns = F, col = as.function(conndata_cmap_oe_stp2_tags$f1), name= paste0(secondCellLine, " CMap Connectivity (oe)"),row_names_gp = gpar(fontsize = rowLabelSizeRest, fontface = "bold", col=cols_cmap_oe_Con2),column_names_gp = gpar(fontsize = 15, fontface = "bold"),row_title = paste0(secondCellLine, " CMap Connectivity (oe)"), row_title_rot = 0, heatmap_legend_param=list(legend_direction="horizontal",grid_height = unit(gridheights, "cm"),grid_width = unit(gridwidths, "cm"),labels_gp = gpar(fontsize = 7),title_gp = gpar(fontsize = legendTitleFontSize, fontface = "bold")), na_col = nacols,height = 1.5,use_raster=F); if(conndata_cmap_oe_stp2_tags$f1tag){ht14@matrix_legend_param$at=conndata_cmap_oe_stp2_tags$at;ht14@matrix_legend_param$labels=conndata_cmap_oe_stp2_tags$labels}
    
    #Store the heatmaps as a list in vertical order, then draw them
    if(!summaryDATA){
    ht_list=ht1 %v% ht2  %v% ht3  %v% ht4  %v% ht12  %v% ht13  %v% ht14
    }else{ht_list=ht1 %v% ht3  %v% ht4 %v% ht13  %v% ht14}
  } else if(!summaryDATA){ht_list=ht1 %v% ht2  %v% ht3  %v% ht4
  }else{ht_list=ht1  %v% ht3  %v% ht4}
  
  tmpheat=draw(ht_list, heatmap_legend_side = "bottom", main_heatmap="SwissTarget \nsimilarity scores",annotation_legend_list = lgd_list,annotation_legend_side = "bottom",merge_legend = TRUE, column_title = paste0(paste0(c(CellLine,secondCellLine),collapse = '&')," - SwissTarget and Connectivity data compilation"), column_title_gp = gpar(fontsize = 16, fontface='bold'))
  heatmaps[['Multimap']]=tmpheat
  dev.off()})
  if(class(a)=='try-error'){dev.off()
    setwd(gsub(x=currentdir,pattern = '(ymnmurat/CMap_iLINCS).*','\\1')) }
  a
}
